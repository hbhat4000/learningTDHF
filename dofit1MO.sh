...
python fitMO.py --gpu 0 --mol heh+ --basis 6-311G --train ./trajdata100/train_heh+_6-311G.npy --ntrain 200000 --dt 0.0008268 --outfname ./MOthetas100/theta_heh+_6-311G.npz > ./logsMO/heh+_6-311G_fit2.out
