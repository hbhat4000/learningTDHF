...
python fitMOiter.py --gpu 0 --mol heh+ --basis 6-31g --train ./trajdata100/train_heh+_6-31g.npy --ntrain 200000 --dt 0.0008268 --tol 1e-16 --maxiter 200000 --outfname ./MOiterthetas100/theta_heh+_6-31g.npz > ./logsMOiter/heh+_6-31g_fit2.out
