...
for i in ${!molsys[@]}; do
    ...
    if [ $i -eq 0 ] || [ $i -eq 1 ] || [ $i -eq 2 ] || [ $i -eq 4 ]; then
        ...
        python hamerrorPG.py --gpu 0 --mol $1 --basis $2 --theta custom --custom $thetapath/theta_lowtol_$1_$2.npz --npzkey x
    else
        thetapath="./PGthetas100"
        python hamerrorPG.py --gpu 0 --mol $1 --basis $2 --theta custom --custom $thetapath/theta_lowtol_$1_$2.npz --npzkey x
    fi
...
for i in ${!molsys[@]}; do
    ...
    if [ $i -eq 0 ] || [ $i -eq 1 ] || [ $i -eq 2 ] || [ $i -eq 4 ]; then
        thetapath="./PGthetas100"
        python hamerrorPG.py --gpu 0 --mol $1 --basis $2 --theta custom --custom ./PGthetas100/thetaR_lowtol_$1_$2.npz --npzkey x
    else
        thetapath="./PGthetas100"
        python hamerrorPG.py --gpu 0 --mol $1 --basis $2 --theta custom --custom ./PGthetas100/thetaR_lowtol_$1_$2.npz --npzkey x
    fi
