...
python fitMO.py --gpu 1 --mol lih --basis 6-31g --train ./trajdata100/train_lih_6-31g.npy --ntrain 200000 --dt 0.0008268 --outfname ./MOthetas100/theta_lih_6-31g.npz > ./logsMO/lih_6-31g_fit2.out
